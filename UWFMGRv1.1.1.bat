...
echo       3z.Exclude Current Profile
echo                        3e.Return
set "OPT1="
...
:: Add exceptions for current user.
:program
set "PRO="
set /p PRO=Enter profile to add exceptions too = 
cls
uwfmgr file add-exclusion "C:\Users\%PRO%\Desktop"
pause > NUL
cls
uwfmgr file add-exclusion "C:\Users\%PRO%\Downloads"
pause > NUL
cls
uwfmgr file add-exclusion "C:\Users\%PRO%\Contacts"
pause > NUL
cls
uwfmgr file add-exclusion "C:\Users\%PRO%\Documents"
pause > NUL
cls
uwfmgr file add-exclusion "C:\Users\%PRO%\Favorites"
pause > NUL
cls
uwfmgr file add-exclusion "C:\Users\%PRO%\Links"
pause > NUL
cls
uwfmgr file add-exclusion "C:\Users\%PRO%\Music"
pause > NUL
cls
uwfmgr file add-exclusion "C:\Users\%PRO%\.cisco"
pause > NUL
cls
uwfmgr file add-exclusion "C:\Users\%PRO%\OneDrive"
pause > NUL
cls
uwfmgr file add-exclusion "C:\Users\%PRO%\Pictures"
pause > NUL
cls
uwfmgr file add-exclusion "C:\Users\%PRO%\Saved Games"
pause > NUL
cls
uwfmgr file add-exclusion "C:\Users\%PRO%\Searches"
pause > NUL
cls
uwfmgr file add-exclusion "C:\Users\%PRO%\Videos"
pause > NUL
cls
uwfmgr file add-exclusion "C:\Users\%PRO%\NTUSER.DAT"
pause > NUL
cls
uwfmgr file add-exclusion "C:\Users\%PRO%\AppData\Local\slack"
cls
echo.
echo.
echo.
...
:: Show current config on all levels of. 
:config
cls
MODE con:cols=80 lines=80
uwfmgr get-config
pause > NUL
uwfmgr get-config > UWFMGR.TXT
pause > NUL
goto :begin

:: Shutdown Computer using uwfmgr tool.
:shut
echo !!SHUTTING DOWN!!
uwfmgr filter shutdown
goto :begin

:: Restart the computer using UWFMGR tool.
:rest
echo  !!RESTARTING!!
